...
def description():
    st.markdown(
        ...
        <h5 class="custom-details">A machine learning project for categorizing Zalando’s fashion items (shirts, shoes, bags) into predefined classes using neural networks.</h5>
