...
def description():
    st.markdown(
        ...
        <h3 class="custom-heading2">1. MNIST Digit Recognition:</h3>
        ...
        <h3 class="custom-heading2">3. Credit Card Fraud Detection:</h3>
        ...
        <h3 class="custom-heading2">4. Customer Churn Prediction:</h3>
