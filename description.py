...
def description():
    st.markdown(
        ...
        <h3 class="custom-heading2">3. <u>MNIST Digit Recognition</u>:</h3>
        ...
        <h3 class="custom-heading2">4. <u>Fashion MNIST Classification</u>:</h3>
        ...
        <h3 class="custom-heading2">5. <u>Temperature Prediction</u>:</h3>
